<?php
$page_title = 'Détails du article';
require_once __DIR__ . '/../../includes/header.php';

$db = Database::getInstance();
$id = $_GET['id'] ?? 0;

// Récupération du article
...
// Statistiques
$db->prepare("SELECT COUNT(*) as count FROM employes WHERE article_id = :id AND actif = 1");
$db->bind(':id', $id);
...
// Liste des employés
$db->prepare("SELECT * FROM employes WHERE article_id = :id AND actif = 1 ORDER BY nom, prenom");
$db->bind(':id', $id);
...
<div class="container-fluid main-container">
    <div class="row mb-4">
        <div class="col-12">
            <div class="d-flex justify-content-between align-items-center">
                <div>
                    <h2><i class="bi bi-box-seam"></i> Détails du article</h2>
    ...
    <div class="row">
        ...
        <div class="col-md-8">
            ...
            <div class="card">
                <div class="card-header">
                    <i class="bi bi-people"></i> Employés du article (<?php echo $nb_employes; ?>)
                </div>
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <p class="text-muted text-center mb-0">Aucun employé dans ce article.</p>
                    <?php endif; ?>
                </div>
            </div>
        </div>
            ...
            <div class="card no-print">
                ...
                <div class="card-body">
                    <div class="d-grid gap-2">
                        <a href="<?php echo BASE_URL; ?>/pages/employes/create.php?article_id=<?php echo $id; ?>"
                           class="btn btn-sm btn-outline-primary">
                            <i class="bi bi-plus-circle"></i> Ajouter un employé
                        </a>
                        <a href="<?php echo BASE_URL; ?>/pages/employes/index.php?article_id=<?php echo $id; ?>"
